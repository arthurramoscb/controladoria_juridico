...
df_pgto_garantias_civel_final.write.format("delta").option("mergeSchema", "true").mode("overwrite").saveAsTable("databox.juridico_comum.hist_pagamentos_garantias_civel_f")
